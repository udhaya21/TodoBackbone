<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <% String userName=( String) session.getAttribute( "givenName"); String loggedInUser=( String) session.getAttribute( "email"); if (request.getSession().getAttribute( "email") !=null) { response.sendRedirect( "/index"); } %>
...
/* Create a Parallax Effect */
        ...
        <body>
            <!-- Navbar (sit on top) -->
            <div class="im-top">
                <ul class="im-navbar" id="myNavbar" style="background-color: black;">
                    <li class="im-hide-medium im-hide-large im-opennav im-right">
                        <a class="im-hover-black" href="javascript:void(0);" onclick="toggleFunction()" title="Toggle Navigation Menu"> <i class="fa fa-bars"></i>
                        </a>
                    </li>
                    <li class="im-left-align"><a href="#home">HOME</a>
                    </li>
                    <li class="im-hide-small"><a href="#about"><i
					class="fa fa-user"></i> ABOUT</a>
                    </li>
                    <li class="im-hide-small"><a href="#mycollections"><i
					class="fa fa-th"></i> MY COLLECTIONS</a>
                    </li>
                    <li class="im-hide-small"><a href="#todoapp"><i
					class="fa fa-list"></i> TODO APP</a>
                    </li>
                    <li class="im-hide-small"><a href="#contact"><i
					class="fa fa-envelope"></i> CONTACT</a>
                    </li>
                    <li class="im-hide-small" style="float:right"><a id="login_li" href="#todoapp"><i class="fa fa-sign-in" style="font-size:20px"></i> LOGIN</a>
                    </li>
                </ul>
                <!-- Navbar on small screens -->
                <div id="navDemo" class="im-hide im-hide-large im-hide-medium">
                    <ul class="im-navbar im-left-align im-white">
                        <li><a href="#about" onclick="toggleFunction()">ABOUT</a>
                        </li>
                        <li><a href="mycollections" onclick="toggleFunction()">MY
						COLLECTIONS</a>
                        </li>
                        <li><a href="#contact" onclick="toggleFunction()">CONTACT</a>
                        </li>
                        <li><a href="#">SEARCH</a>
                        </li>
                    </ul>
            ...
            <div class="im-content im-container im-padding-64" id="about">
                ...
                <p style="text-align: justify;">
                    I'm Udhaya, Junior Support engineer, working in Full creative. If you need any support in Setmore, then that's where I come. My Job is to make people feel easy and comfortable as well as happy by providing the answers to their questions. This includes the problem solving, which the customer faces with the product. I'd love to help others. As many struggle I face in my life has given me many lessons. Here the lesson means my experience. You lose only you think you cannot move further. If you move further when you face failure then it is a hurdle. <b style="font-weight: bold; font-family: cursive;">I've
				never failed, but I have found 10,000 ways that doesn't work</b> - Thomas Edison
                </p>
                <script id="setmore_script" type="text/javascript" src="https://my.setmore.com/js/iframe/setmore_iframe.js"></script>
                <a id="Setmore_button_iframe" style="float: none; position: relative; left: 70px;" style="float:none" href="https://my.setmore.com/bookingpage/512954fd-5435-4ba1-a582-1a750ac57ff4"><img border="none" src="https://my.setmore.com/images/bookappt/SetMore-book-button.png" alt="Book an appointment with softSolutions using SetMore" />
                </a>
                <div class="im-row">
                    <div class="im-col m6 im-center im-padding-large">
                        ...
                        <br> <img src="images/mypic.jpg" class="im-round im-image im-opacity im-hover-opacity-off" alt="Photo of Me" width="500" height="333">
                    </div>
                    <!-- Hide this text on small devices -->
                    <div class="im-col m6 im-hide-small im-padding-large">
                        <p style="position: relative;top: 70px;text-align: justify;">Welcome to my website. This is a website which is built by me. You can also reach me out by contacting me for your queries that you have in Setmore. I've also learned how to assemble the desktop and OS installation. You can also book appointments/sessions with me. I love to collect the pictures which I have added here.</p>
                    </div>
                </div>
                <p class="im-large im-center im-padding-16">I'm really good at:</p>
                <p class="im-wide">
                    <i class="fa fa-coffee"></i>Java
                </p>
                <div class="im-light-grey">
                    <div class="im-container im-padding-small im-dark-grey im-center" style="width: 90%">90%</div>
                </div>
                <p class="im-wide">
                    <i class="fa fa-laptop"></i>Web Design
                </p>
                <div class="im-light-grey">
                    <div class="im-container im-padding-small im-dark-grey im-center" style="width: 85%">85%</div>
                </div>
                <p class="im-wide">
                    <i class="fa fa-photo"></i>App engine Services
                </p>
                <div class="im-light-grey">
                    <div class="im-container im-padding-small im-dark-grey im-center" style="width: 75%">75%</div>
                </div>
            </div>
            <div class="im-row im-center im-dark-grey im-padding-16">
                <div class="im-quarter im-section">
                    <span class="im-xlarge">50+</span>
                    <br> Customer
                </div>
                <div class="im-quarter im-section">
                    <span class="im-xlarge">55+</span>
                    <br> OS Installation
                </div>
                <div class="im-quarter im-section">
                    <span class="im-xlarge">89+</span>
                    <br> Happy Clients
                </div>
                <div class="im-quarter im-section">
                    <span class="im-xlarge">150+</span>
                    <br> Meetings
                </div>
            </div>
            ...
            <div class="bgimg-2 im-display-container im-opacity-min">
                <div class="im-display-middle">
                    <span class="im-xxlarge im-text-light-grey im-wide im-collections" style="color: black !important;">My </span><span class="im-xxlarge im-text-light-grey im-wide" style="color: black !important;">Collections</span>
                </div>
            </div>
            ...
            <div class="im-content im-container im-padding-64" id="mycollections">
                ...
                <div class="im-row-padding im-center">
                    <div class="im-col m3">
                        <img src="images/bg1.png" class="imgsmall img1" onclick="onClick(this)" class="im-hover-opacity" alt="Reach me any time">
                    </div>
                    <div class="im-col m3">
                        <img src="images/bg2.jpg" class="imgsmall img2" onclick="onClick(this)" class="im-hover-opacity" alt="Waterproof">
                    </div>
                    <div class="im-col m3">
                        <img src="images/bg4.jpg" class="imgsmall img3" onclick="onClick(this)" class="im-hover-opacity" alt="Keyboard">
                    </div>
                    <div class="im-col m3">
                        <img src="images/bbg5.jpg" class="imgsmall img4" onclick="onClick(this)" class="im-hover-opacity" alt="Processor">
                    </div>
                    <button class="im-btn-load im-btn im-light-grey im-padding-xlarge" style="margin-top: 64px; margin-bottom: 64px; position: relative; right: 100px;" id="loadmore" onclick="loadmore();">Load My Favorite Personalities
                    </button>
                </div>
                <div class="im-row-padding im-center im-section" id="favperson" style="display: none;position: relative;left: 100px;">
                    <div class="im-col m3">
                        <img src="images/jonyive.jpg" class="imgsmall img5" onclick="onClick(this)" class="im-hover-opacity" alt="Jony Ive">
                    </div>

                    <div class="im-col m3">
                        <img src="images/sundar.jpg" class="imgsmall img7" onclick="onClick(this)" class="im-hover-opacity" alt="Sundar Pichai">
                    </div>
                    <div class="im-col m3">
                        <img src="images/steve.jpg" class="imgsmall img8" onclick="onClick(this)" class="im-hover-opacity" alt="Steve Jobs">
                    </div>
                </div>
            </div>
            <!-- Modal for full size images on click-->
            <div id="modal01" class="im-modal im-black" onclick="this.style.display='none'">
                <span class="im-closebtn im-text-white im-opacity im-hover-opacity-off im-xxlarge im-container im-display-topright" title="Close Modal Image"><i class="fa fa-remove"></i></span>
                <div class="im-modal-content im-animate-zoom im-center im-transparent im-padding-64">
            ...
            <div class="bgimg-4 im-display-container im-opacity-min">
                <div class="im-display-middle">
                    <span class="im-xxlarge im-text-light-grey im-wide" style="color: black !important;"></span>
                </div>
            </div>
            ...
            <div class="im-content im-container im-padding-64" id="todoapp">
                ...
                <p>Todo is used by millions of individuals, families and teams for GETTING THINGS DONE. Todoist is another thoughtfully designed, powerful, and intuitive app for managing your tasks. "Todo has stood the test of time" -Silicon Slopes.</p>
                <div class="im-center">
                    <a id="mybtn" class="button cta open-signup">Create an account</a>
                </div>
            ...
            <div class="bgimg-3 im-display-container im-opacity-min">
                <div class="im-display-middle">
                    <span class="im-xxlarge im-text-light-grey im-wide" style="color: black !important;">CONTACT</span>
                </div>
            </div>
            ...
            <div class="im-content im-container im-padding-64" id="contact">
                ...
                <div class="im-row im-padding-32 im-section">
                    <div class="im-col m4 im-container">
                        <!-- Add Google Maps -->
                        <div id="googleMap" class="im-round-large im-greyscale" style="width: 100%; height: 400px;"></div>
                    </div>
                    <div class="im-col m8 im-container im-section">
                        <div class="im-large im-margin-bottom" style="color: black;">
                            <i class="fa fa-map-marker fa-fw im-hover-text-black im-xlarge im-margin-right" style="color: red !important;"></i> Chennai, India
                            <br> <i class="fa fa-phone fa-fw im-hover-text-black im-xlarge im-margin-right" style="color: greenyellow !important;"></i> Phone: +91 9940020612
                            <br>
                            <i class="fa fa-envelope fa-fw im-hover-text-black im-xlarge im-margin-right" style="color: blueviolet !important;"></i> Email: prakashaudhaya@gmail.com
                            <br>
                        </div>
                        <p>
                        ...
                        <form method="POST">
                            <div class="im-row-padding" style="margin: 0 -16px 8px -16px">
                                <div class="im-half">
                                    <input class="im-input im-border" type="text" placeholder="Name" required name="Name" id="name">
                                </div>
                                <div class="im-half">
                                    <input class="im-input im-border im-input-email" type="email" placeholder="Email" required name="Email" id="email">
                                </div>
                            </div>
                            <input class="im-input im-border" type="text" placeholder="Message" required name="Message" id="message">
                            <button class="im-btn im-black im-right im-padding im-section" onclick="sendEmail();">
                                <i class="fa fa-paper-plane"></i> SEND MESSAGE
                            </button>
                            <input type="RESET" class="im-btn im-black im-left im-padding im-section"> RESET
                        </form>
                        <span id="ack"></span>
                    </div>
                </div>
            ...
            <!-- Footer -->
            <footer class="im-center im-black im-padding-64 im-opacity im-hover-opacity-off">
            ...
            <script>
                ...
                function myFunction() {
                    ...
                    if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
                        navbar.className = "im-navbar" + " im-card-2" + " im-animate-top" + " im-white";
                    } else {
                ...
                function loadDoc() {
                    ...
                    xhttp.open("POST", "/email?name=" + name + "&email=" + email + "&message=" + message, true);
                    xhttp.send();
                }
            </script>
